...
echo '<br><div class="stats" align="center"> '.$helpdesk_name.'<b> Database:'.$db_name.'</b><br>';
echo "$lang_powered Peter & <b><a href=\"https://odoo.casaria.net\">TheTeam</a></b> V$version<br>";
echo "Aditional redits <a href=\"https://icons8.com/icon/44052/Shopping-Cart-Loaded\"> icon credits</a><br>";
if($enable_stats == 'On'){
