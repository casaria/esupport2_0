...
class DBIGenerator{
    ...
    public function generate(){
        ...
        if(!$result=mysqli_query($dbg,'SHOW COLUMNS FROM '.$this->table)){
        ...
        $str.='public function load($sql){'.$lt.'$r=mysql_query($sql);'.$lt;
        ...
        $str.='$this->sql='."SELECT * FROM'.$this->table.' WHERE id=\'$this->id\'";
