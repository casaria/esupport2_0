...
public function submit(){mysql_query("INSERT INTO tickets SET create_date='$this->create_date',groupid='$this->groupid',ugroupid='$this->ugroupid',supporter='$this->supporter',supporter_id='$this->supporter_id',priority='$this->priority',status='$this->status',BILLING_STATUS='$this->BILLING_STATUS',user='$this->user',email='$this->email',office='$this->office',phone='$this->phone',equipment='$this->equipment',category='$this->category',platform='$this->platform',short='$this->short',description='$this->description',update_log='$this->update_log',survey='$this->survey',lastupdate='$this->lastupdate',emailgroup='$this->emailgroup',emailstatuschange='$this->emailstatuschange',emailcc='$this->emailcc',closed_date='$this->closed_date'");$this->id=mysql_insert_id();}public function update(){mysql_query("UPDATE tickets SET create_date='$this->create_date',groupid='$this->groupid',ugroupid='$this->ugroupid',supporter='$this->supporter',supporter_id='$this->supporter_id',priority='$this->priority',status='$this->status',BILLING_STATUS='$this->BILLING_STATUS',user='$this->user',email='$this->email',office='$this->office',phone='$this->phone',equipment='$this->equipment',category='$this->category',platform='$this->platform',short='$this->short',description='$this->description',update_log='$this->update_log',survey='$this->survey',lastupdate='$this->lastupdate',emailgroup='$this->emailgroup',emailstatuschange='$this->emailstatuschange',emailcc='$this->emailcc',closed_date='$this->closed_date' WHERE id='$this->id'");}public function delete(){mysql_query("DELETE FROM tickets WHERE id='$this->id'");}}?>$this->sql=SELECT * FROM'.tickets.' WHERE id=\'\'