...
function createTimeTab()
{
    ...
    <tr>
     ...
     <td class="back" colspan="4"><inout type=text class=cas-tb1  size=30 name=emailcc value="' . $info['emailcc'] . '"></td></tr>';
        endTable();
    }
...
//}
        ...
        echo '			<tr>
							...
							<td class=back>
								<inout type=text class=cas-tb1  size=20 name=username value="' . $info['user'] . '">
							</td></tr><tr>
							<td class=back2 align=right>' . $lang_email . ': </td>
							<td class=back align=left>
								<inout type=text class=cas-tb1  size=20 name=user_email value="' . $info['email'] . '">
							</td>
						...
						<tr>    
							...
							<td class=back>
								<inout type=text class=cas-tb1  size=20 name=office value="' . $info['office'] . '">
							</td></tr><tr>

							<td class=back2 align=right>' . $lang_phoneext . ':</td>
							<td cl-ass=back>
								<inout type=text class=cas-tb1  size=20 name=phone value="' . $info['phone'] . '">
							</td>';
...
{
        global $info, $db, $lang_never, $mysql_attachments_table, $id, $lang_ticket, $lang_opened, $lang_attachments, $lang_lastupdate, $lang_status, $g_tkt_id_padded, $g_tkt_uGoup_name;

        $g_tkt_id_padded = str_pad($id, 5, '0', STR_PAD_LEFT);
...
/*
        ...
        function extraTab2()
        {
            ...
            ?>
            <div class="progress">
                    <div class="progress-bar bg-warning" role="progressbar" style="width: 89%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <div class="progress">
