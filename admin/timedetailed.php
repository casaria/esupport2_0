...
if(isset($getstats)){
	...
	foreach($list as $value){
		...
		if($create_date != ''){
			...
			startTable("<a href=\"".$supporter_site_url."/index.php?t=tupd&id=".$value."\"><b>$lang_ticket $value:</b></a> $uGroupName / <img height=20 src=\"../$theme[image_dir]$bsIconRef\"> / $ticket[equipment] / $ticket[short] ", "left", 100, 2, "extra");
