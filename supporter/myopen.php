				...
				<td> 
					<table cellSpacing=1 cellPadding=5 width="100%" border=0>
						<tr>';
							...
							if($s == 'up'){
								echo '<td align=center>
														  <a class=hf href="'.$supporter_site_url.'/index.php?t=tmop&f='.$f.'&s=pu"><b>'.$lang_created.'</b></a></td>';
							}
							else{
								echo '<td align=center>
														  <a class=hf href="'.$supporter_site_url.'/index.php?t=tmop&f='.$f.'&s=up"><b>'.$lang_created.'</b></a></td>';
							}
