...
private $model='';
private $Serialnum='';
private $asset_tag_customer='';
private $service_id_barcode='';
...
public function setasset_tag_customer($asset_tag_customer) {$this->asset_tag_customer=$asset_tag_customer;}
public function getasset_tag_customer(){return $this->asset_tag_customer;}
public function setservice_id_barcode($service_id_barcode) {$this->service_id_barcode=$service_id_barcode;}
public function getservice_id_barcode(){return $this->service_id_barcode;}
...
$this->asset_tag_customer=$row['asset_tag_customer'];
$this->service_id_barcode=$row['service_id_barcode'];
...
public function submit(){mysql_query("INSERT INTO tequipment SET platform_id='$this->platform_id',rank='$this->rank',equipcat='$this->equipcat',groupid='$this->groupid',short='$this->short',description='$this->description',make='$this->make',model='$this->model',Serialnum='$this->Serialnum',asset_tag_customer='$this->asset_tag_customer',service_id_barcode='$this->service_id_barcode',suplementary_data='$this->suplementary_data',runtimemiles='$this->runtimemiles',dt_rtm_inception='$this->dt_rtm_inception',rtm_update='$this->rtm_update',dt_rtm_updae='$this->dt_rtm_updae',mfctdate='$this->mfctdate',activation='$this->activation',state='$this->state'");$this->id=mysql_insert_id();}public function update(){mysql_query("UPDATE tequipment SET platform_id='$this->platform_id',rank='$this->rank',equipcat='$this->equipcat',groupid='$this->groupid',short='$this->short',description='$this->description',make='$this->make',model='$this->model',Serialnum='$this->Serialnum',asset_tag_customer='$this->asset_tag_customer',service_id_barcode='$this->service_id_barcode',suplementary_data='$this->suplementary_data',runtimemiles='$this->runtimemiles',dt_rtm_inception='$this->dt_rtm_inception',rtm_update='$this->rtm_update',dt_rtm_updae='$this->dt_rtm_updae',mfctdate='$this->mfctdate',activation='$this->activation',state='$this->state' WHERE id='$this->id'");}public function delete(){mysql_query("DELETE FROM tequipment WHERE id='$this->id'");}}?>$this->sql=SELECT * FROM'.tequipment.' WHERE id=\'\'