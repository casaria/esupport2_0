					...
					<table cellSpacing=1 cellPadding=5  width="100%" border=0>
						...
						<tr>';
                          ...
                          echo '	</td><td class=back2 width="180px" align=right>* '.$lang_category.':</td>
							<td class=back><select width="375px" name=category>';  createCategoryMenu(0);
                          echo '	</select></td>';

						echo '</tr><tr>
                             	<td class=back2 width="180px" align=right>* '.$lang_platform.':</td>
							<td class=back><select  width="375px" name=platform>'; createPlatformMenu(0);
						...
						<tr>
							...
							<td class=back><select  width="375px" name=equipment>';  createEquipmentMenu(0,$equipmentgroupid);
							echo '	</select></td>
