...
<?php
        ...
        echo "<div class=\"col-xs-6 col-md-3\"><input type=submit id=submit name=update height=80 value=\"$lang_updateticket\"></div>";
        echo "</form>";
        ...
        echo "<div class=\"col-xs-6 ml-auto col-md3\"><input type=submit id=submit name=dumptokb height=80 value=\"$lang_dumptokb\"></form></div>";
        }
        Echo "</div>";
        ?>
</div>
