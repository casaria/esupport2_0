...
function updateLogUserView($log){
	global $lang_updates, $delimiter, $update_log, $lang_emailsent, $lang_fileattached, $lang_emailsent, $lang_updatedby, $lang_ticketcreatedby, $cookie_name, $lang_transferred, $lang_prioritychange, $lang_statuschange;
