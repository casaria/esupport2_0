...
?>
    ...
    <div class="container">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="pills-scan-tab" data-toggle="pill" href="#scan" role="tab" aria-controls="pills-scan" aria-selected="true"><h4>Scan</h4></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-tkt-tab" data-toggle="pill" href="#tkt" role="tab" aria-controls="pills-tkt" aria-selected="false"><h4>Tkt</h4></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-xtra-tab" data-toggle="pill" href="#extra" role="tab" aria-controls="pills-extra" aria-selected="false"><h4>Xtra</h4></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-asset-tab" data-toggle="pill" href="#asset" role="tab" aria-controls="pills-asset" aria-selected="false"><h4>Asset</h4></a>
            </li>
        </ul>
...
echo '
    ...
    <tr>
     ...
     <td class="back">
			<input type=text size=35 name=emailcc value="'.'">			
	</td>
    </tr>';
endTable();
}
...
function createUserInfo()
{
	global $db, $mysql_users_table, $lang_createdby, $lang_username, $sg, $userid, $lang_email, $lang_office, $lang_phoneext;
		...
		echo '<tr>
				...
				?>
			    	<select name=userlink class="selectwidth2" onChange="MM_jumpMenu('pills-tab', this,'tkt', 0)">
				<?php	
