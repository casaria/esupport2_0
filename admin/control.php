...
echo "<tr><td width=60% height=40 class=cat> $lang_setting: </td> <td class=cat> $lang_value: </td></tr>";
		...
		echo "<tr>";
			...
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=helpdesk value='$helpdesk_name'></td>";
		echo "</tr>";

		//address_name
		echo "<tr>";
			echo "<td width=60% class=back2>$lang_aname: </td>";
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=aname value='$address_name'></td>";
		echo "</tr>";
		
		//street1
		echo "<tr>";
			echo "<td width=60% class=back2>$lang_street1: </td>";
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=astreet1 value='$address_street1'></td>";
		echo "</tr>";
		
		//street2
		echo "<tr>";
			echo "<td width=60% class=back2>$lang_street2: </td>";
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=astreet2 value='$address_street2'></td>";
		echo "</tr>";
		
		//city
		echo "<tr>";
			echo "<td width=60% class=back2>$lang_city: </td>";
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=acity value='$address_city'></td>";
		echo "</tr>";
		
		//state
		echo "<tr>";
			echo "<td width=60% class=back2>$lang_state: </td>";
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=astate value='$address_state'></td>";
		echo "</tr>";
		
		//zip
		echo "<tr>";
			echo "<td width=60% class=back2>$lang_zip: </td>";
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=azip value='$address_zip'></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=supporter_url ";
		...
		echo "<tr>";
			...
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  size=40 name=admin_url ";
		...
		echo "<tr>";
			...
			echo "<td class=back2> <inout type=text class=cas-tb1 text-2  name=email value='$admin_email'></td>";
		echo "</tr>";
		...
		//forum site url
			...
			echo "<tr>";
				...
				echo "<td class=back2>
						<inout type=text class=cas-tb1 text-2  size=40 name=forum_site value=".$forum_site_url.">
					</select></td>";
			echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td class=back2>
					<inout type=text class=cas-tb1 text-2  size=3 name=interval value=".$rating_interval.">
				</select></td>";
		echo "</tr>";
		*/
		...
		//sendmail path
			echo "<tr>";
				...
				echo "<td class=back2>
						<inout type=text class=cas-tb1 text-2  size=40 name=mail_path value=".$sendmail_path.">
					</select></td>";
			echo "</tr>";
				  ...
				  <TABLE cellSpacing=1 cellPadding=5 width=\"100%\" border=0>
					...
					<TR> 
					  <TD class=info align=left><b> $lang_templates </b></TD>";
						...
						echo "<inout type=text class=cas-tb1 text-2  size=30 maxlength=60 name=tpl> &nbsp;&nbsp;&nbsp;";
