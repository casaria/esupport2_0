...
function startSession() {
    ...
    session_set_cookie_params($session_time,'/', '.casaria.net',0,1);
...
**	is set to 1, the value of each group is set for ticket updating.
************************************************************************************************************/
function createGroupMenu($flagUpdate=0)
{
...
**		Takes no arguments.  Creates the drop down menu for the language list.
************************************************************************************************************/
function createTimeOffsetMenu($time_offset)
{
	global $lang_timezone1, $lang_timezone2, $lang_timezone3, $lang_timezone4, $lang_timezone5, $lang_timezone6,
			...
			$lang_timezone31, $lang_timezone32, $lang_timezone33;

$options= "<option value=-12>$lang_timezone1</option><option value=-11>$lang_timezone2</option>
<option value=-10>$lang_timezone3</option><option value=-9>$lang_timezone4</option><option value=-8>$lang_timezone5</option><option value=-7>$lang_timezone6</option><option value=-6>$lang_timezone7</option><option value=-5> $lang_timezone8 </option><option value=-4>$lang_timezone9</option><option value=-3.5>$lang_timezone10</option><option value=-3>$lang_timezone11</option><option value=-2>$lang_timezone12</option><option value=-1>$lang_timezone13</option><option value=0>$lang_timezone14</option><option value=1>$lang_timezone15</option><option value=2>$lang_timezone16</option><option value=3>$lang_timezone17</option><option value=3.5>$lang_timezone18</option><option value=4>$lang_timezone19</option><option value=4.5>$lang_timezone20</option><option value=5>$lang_timezone21</option><option value=5.5>$lang_timezone22</option><option value=5.75>$lang_timezone23</option><option value=6>$lang_timezone24</option><option value=6.5>$lang_timezone25</option><option value=7>$lang_timezone26</option><option value=8>$lang_timezone27</option><option value=9>$lang_timezone28</option><option value=9.5>$lang_timezone29</option><option value=10>$lang_timezone30</option><option value=11>$lang_timezone31</option><option value=12>$lang_timezone32</option><option value=3>$lang_timezone33</option></select>";

  $result= preg_replace("/value=".$time_offset."/","value=".$time_offset." selected",$options);
  return $result;
}
					...
					<table cellSpacing=1 cellPadding=5  width="100%" border=0>
						...
						<tr>';
                          ...
                          echo '<td class=back2 width=90 align=right>* '.$lang_category.':</td>
							<td class=back><select class="selectwidth" name=category>';  createCategoryMenu(0);
                          echo '</select></td>';

						echo '</tr><tr>
                             	<td class=back2 width=90 align=right>* '.$lang_platform.':</td>
							<td class=back><select class="selectwidth" name=platform>'; createPlatformMenu(0, '');

						echo '</select></TD>   
						</tr>
						<tr>
							<td class=back2 width=90 align=right>* '.$lang_equipment.':</td>
							<td class=back><select class="selectwidth" name=equipment>';  createEquipmentMenu(0,$equipmentgroupid);
							echo '</select></td>
						</tr>
						<tr>
...
function updateLog($ticket_id, $msg)
{
	...
	if((preg_match("/^\$lang_transferred/i", $msg)) || (preg_match("/^\$lang_statuschange/i", $msg)) || (preg_match("/^\$lang_prioritychange/i", $msg))) {
