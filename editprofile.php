	...
	echo "<tr><td class=back>";
		...
		startTable("$lang_editprofile - $lang_required", "left", 100, 2);
			...
			echo "<tr><td width=180 class=back2>$lang_firstname: </td>
				<td class=back> <inout type=text class=cas-tb1  size=30 name=first value=\"".$user_info['first_name']."\"></td></tr>\n";
			echo "<tr><td width=180 class=back2>$lang_lastname: </td>
				<td class=back><inout type=text class=cas-tb1  size=30 name=last value=\"".$user_info['last_name']."\"></td></tr>\n";
			echo "<tr><td width=180 class=back2>$lang_emailaddy: </td>
				<td class=back><inout type=text class=cas-tb1  size=30 name=email value=\"".$user_info['email']."\"></td></tr>\n";
		...
		startTable("$lang_editprofile - $lang_optional", "left", 100, 2);
			...
			echo "<tr><td width=180 class=back2>$lang_timeoffset: </td><td class=back><select name=offset>";
				echo (createTimeOffsetMenu($user_info['time_offset']));
			echo "</select></td></tr>";
			...
			if($enable_pager == 'On' && isSupporter($cookie_name)){
				echo "<tr><td width=180 class=back2>$lang_pager $lang_email: </td><td class=back>
				      <inout type=text class=cas-tb1  size=30 name=pager value=\"".$user_info['pager_email']."\"></td></tr>";
			}
			echo "<tr><td width=180 class=back2>$lang_office: </td>
				<td class=back> <inout type=text class=cas-tb1  size=30 name=office value=\"".$user_info['office']."\"></td></tr>\n";
			echo "<tr><td width=180 class=back2>$lang_phoneext: </td>
				<td class=back> <inout type=text class=cas-tb1  size=30 name=phone value=\"".$user_info['phone']."\"></td></tr>\n";
			echo "<tr><td width=180 class=back2>$lang_yahoo: </td><td class=back>
					<inout type=text class=cas-tb1  size=30 name=yahoo value=\"".$user_info['yahoo']."\"></td></tr>";
			echo "<tr><td width=180 class=back2>$lang_msn: </td><td class=back> <inout type=text class=cas-tb1  size=30 name=msn value=\"".$user_info['msn']."\"></td></tr>";
			echo "<tr><td width=180 class=back2>$lang_icq: </td><td class=back> <inout type=text class=cas-tb1  size=30 name=icq value=\"".$user_info['icq']."\"></td></tr>";
